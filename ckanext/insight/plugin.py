...
class InsightPlugin(plugins.SingletonPlugin):
    ...
    plugins.implements(plugins.ITemplateHelpers)   # <-- penting untuk helpers
    ...
    def get_helpers(self):
        from .helpers import (
            ckanet_insight_list,
            ckanet_count_groups_startswith,
            ckanet_org_counts,  # kalau kamu sudah tambahkan helper ini
        )
        return {
